...
namespace MusicBeePlugin
{
    public partial class Plugin
    {
        ...
        {
            Url = 2,
            Kind = 4, // Generic file type. 'type' field in the properties tab of tracks i.e. 'MPEG audio file'
            Format = 5,
            Size = 7,
            Channels = 8,
            SampleRate = 9,
        ...
        public enum MetaDataType
        {
            ...
            Artwork = 40,              // returns the location of the linked image, otherwise just links to the location of the file
            BeatsPerMin = 41,
        ...
        public delegate string Library_GetFilePropertyDelegate(string sourceFileUrl, FilePropertyType type); // Gets information about a specified file
        public delegate string Library_GetFileTagDelegate(string sourceFileUrl, MetaDataType field); // Gets tag data from a supplied file | 
        ...
        public delegate bool Library_QueryFilesExDelegate(string query, out string[] files);// Use autoplaylist xml to form query
        ...
        public delegate bool Player_SetVolumeDelegate(float volume); // Sets volume to specified value
        public delegate bool Player_GetMuteDelegate();
        public delegate bool Player_SetMuteDelegate(bool mute); // Mutes the volume if true, unmutes if false
        public delegate bool Player_GetShuffleDelegate(); // Gets shuffle value
        public delegate bool Player_SetShuffleDelegate(bool shuffle); // Enables or disables shuffle
        public delegate RepeatMode Player_GetRepeatDelegate(); // Gets repeat value
        public delegate bool Player_SetRepeatDelegate(RepeatMode repeat); // Enables or disables repeat in the form RepeatMode.No = 0, RepeatMode.All = 1, RepeatMode.One = 2
        ...
        public delegate bool Player_SetScrobbleEnabledDelegate(bool enabled); // Sets whether scrobbling is enabled
        public delegate bool Player_GetShowTimeRemainingDelegate(); // Gets time remaining in the playing track
        public delegate bool Player_GetShowRatingTrackDelegate(); // Returns whether or not a track has a rating
        public delegate bool Player_GetShowRatingLoveDelegate(); // Returns whether or not a track is loved
        ...
        public delegate bool Player_UpdatePlayStatisticsDelegate(string url, PlayStatisticType countType, bool disableScrobble); // Increments the play or skip value
        public delegate bool Player_GetOutputDevicesDelegate(out string[] deviceNames, out string activeDeviceName);
        public delegate bool Player_SetOutputDeviceDelegate(string deviceName); // Sets the output device. If no hotkey, use to make a simple hotkey plugin

        public delegate string NowPlaying_GetFileUrlDelegate(); // Returns the currently playing file URL
        public delegate int NowPlaying_GetDurationDelegate(); // Returns the duration of the currently playing file in milliseconds
        public delegate string NowPlaying_GetFilePropertyDelegate(FilePropertyType type); // Gets file type of the currently playing file
        public delegate string NowPlaying_GetFileTagDelegate(MetaDataType field); // Returns the given tag value from the currently playing file
        ...
        public delegate bool Playlist_QueryPlaylistsDelegate(); // Unknown.
        public delegate string Playlist_QueryGetNextPlaylistDelegate(); // |||||||||||
        public delegate bool Playlist_IsInListDelegate(string playlistUrl, string filename); // Determines if a given song is in a given playlist
